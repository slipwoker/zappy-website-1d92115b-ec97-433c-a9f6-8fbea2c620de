document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getErrorMessage(rule, param) {
      if (typeof ERROR_MESSAGES[rule] === 'function') {
        return ERROR_MESSAGES[rule](param);
      }
      return ERROR_MESSAGES[rule] || 'Invalid value.';
    }
    ...
    function validateField(field) {
      ...
      if (type === 'tel' && value.trim() !== '' && !VALIDATORS.tel(value)) {
        showError(field, getErrorMessage('tel'));
        return false;
      }

      if (minlength && value.trim() !== '' && !VALIDATORS.minlength(value, minlength)) {
        showError(field, getErrorMessage('minlength', minlength));
        return false;
      }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "שיווק מהיר משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '1d92115b-ec97-433c-a9f6-8fbea2c620de',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '1d92115b-ec97-433c-a9f6-8fbea2c620de';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1d92115b-ec97-433c-a9f6-8fbea2c620de';
